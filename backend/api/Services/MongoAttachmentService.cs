...
public class MongoAttachmentService
{
    private readonly IMongoDatabase _database;
    private readonly GridFSBucket _gridFS;

    public MongoAttachmentService(IConfiguration config)
    {
    ...
    public async Task<List<GridFSFileInfo>> GetImagesByAssignmentAsync(Guid assignmentId)
    {
